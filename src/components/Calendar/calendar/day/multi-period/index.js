...
class Day extends Component {
  ...
  render() {
    ...
    const numinW = moment(this.props?.date?.dateString).day()
    ...
    return (
      <View style={{ alignSelf: 'stretch' }}>
        ...
        >
          <Text allowFontScaling={false} style={[textStyle, { color: numinW === 0 ? 'red' : '#2d4150' }]}>{String(this.props.children)}</Text>
